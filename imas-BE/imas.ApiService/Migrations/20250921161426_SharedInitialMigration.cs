...
{
    /// <inheritdoc />
    public partial class SharedInitialMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assets_Assets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assets_Categories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_General_Companies", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "General_Departments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HeadOfDepartment = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_General_Departments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_General_Locations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_General_Roles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assets_Assignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Assets_Assignments_Assets_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets_Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "Assets_MaintenanceRecords",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assets_MaintenanceRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Assets_MaintenanceRecords_Assets_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets_Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assets_Assets_AssetTag",
                table: "Assets_Assets",
                column: "AssetTag",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Assets_Assignments_AssetId",
                table: "Assets_Assignments",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_Assets_MaintenanceRecords_AssetId",
                table: "Assets_MaintenanceRecords",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_Finance_Invoices_InvoiceNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HR_Employees_EmployeeNumber",
                table: "HR_Employees",
