...
namespace imas.General.ApiService.Infrastructure.Extensions;

/// <summary>
/// Database configuration extensions for General service
/// </summary>
public static class DatabaseExtensions
{
    ...
    public static async Task<WebApplication> InitializeDatabaseAsync(this WebApplication app)
    {
        ...
        var context = scope.ServiceProvider.GetRequiredService<GeneralDbContext>();
        var logger = scope.ServiceProvider.GetRequiredService<ILogger<GeneralDbContext>>();
