...
public class AuthenticationModule : IModule
{
    ...
    {
        services.Configure<mara.ApiService.Configuration.JwtOptions>(
            configuration.GetSection(mara.ApiService.Configuration.JwtOptions.SectionName));
        ...
        IJwtService jwtService)
    {
        ...
        var token = jwtService.GenerateToken(user.Username, user.Email, user.Roles);
